...
import { getProviderColor, getProviderLabel } from "@/features/stats/utils/provider-colors"
...
function StorageTooltipContent({ active, payload }: { active?: boolean; payload?: { payload: TreemapItem }[] }) {
  ...
  if (treeData.length === 0) {
    return (
      <Card className="w-full">
        <CardHeader>
          <CardTitle className="text-sm font-medium">Occupation par storage</CardTitle>
        </CardHeader>
